...
export default function ProductsContent() {
  ...
  return (
    <section className="mt-10 flex flex-col justify-center max-w-[1500px] min-h-screen mx-auto">
      <h2 className="text-xl sm:text-3xl 2xl:text-6xl  font-semibold tracking-widest md:leading-20 px-8 lg:px-0 mb-6  text-gray-800">
        {t("title")}
      </h2>
      <div>
        <ul className="mt-12 flex  justify-center gap-3 flex-wrap">
          {fishCategories.map((cat, idx) => {
            return (
              ...
              >
                ...
                <Link href={`/${localeRaw}/products/${cat.id}`}>
