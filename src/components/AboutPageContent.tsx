...
export default function AboutPageContent() {
      ...
      <div className="  mx-auto px-8 lg:px-0  lg:max-w-5xl xl:max-w-6xl  2xl:max-w-[1500px]">
        ...
        <section className="flex flex-col  bg-[url('/img/bgAbout2.png')] bg-cover bg-center  justify-center w-full min-h-screen mx-auto">
          ...
          <main className="flex flex-wrap justify-center gap-22">
            ...
            <div className="max-w-lg">
              ...
              <ul className="lg:text-xl leading-relaxed text-gray-600 flex flex-col gap-6">
        ...
        <section className="flex flex-col justify-center w-full min-h-screen mx-auto mt-[200px]">
          ...
          <main className="flex items-center  flex-wrap justify-around">
            <ul className="max-w-xl lg:text-xl leading-relaxed text-gray-600 lg:h-[500px] py-6 lg:py-0 flex flex-col gap-8">
 ...
 <h2 className="text-xl max-w-3xl  font-semibold tracking-widest md:leading-20 sm:text-3xl 2xl:text-5xl  mb-6">
              ...
              <li className="leading-relaxed text-gray-600">{t("price.part1")}</li>

              <li className="leading-relaxed text-gray-600">{t("price.part2")}</li>

              <li className="leading-relaxed text-gray-600">{t("price.part3")}</li>
            </ul>
          </main>
        </section>
        <section>
